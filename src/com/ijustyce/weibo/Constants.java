...
public interface Constants {
	...
	public static final String GET_COMMON_FRIENDS="https://api.weibo.com/2/friendships"
			+ "/friends/in_common.json";
	public static final String GET_LASTEST="https://api.weibo.com/2/statuses/home_timeline.json";
	...
	public static final String METHOD_LASTEST="METHOD_LASTEST";
